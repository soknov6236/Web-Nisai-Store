        ...
        <form id="addSaleForm" action="sale/sale_add.php" method="POST" enctype="multipart/form-data">
            <div class="row">
                <div class="col-md-12 mb-3">
                    ...
                    <div id="searchResults" class="mt-2 more-view-grid"></div>
                </div>
            </div>
                    ...
                    success: function (data) {
                        ...
                        if (products.length > 0) {
                            products.forEach(function (product) {
                                html += `
                                    <div class="search-result" data-code="${product.product_code}" data-name="${product.name}" data-price="${product.price}" data-color="${product.color}" data-stock="${product.stock}">
                                        <img src="product/uploads/${product.image}" width="80" height="80">
                                        <div>
                            ...
                            html = "<div class='search-result'>No products found.</div>";
                        }
