      ...
      $(function(){
            $("#btnregister").click(function(){
                ...
                if(user=="" || email=="" || pass=="" || confirmPass==""){
                    ...
                    $.post("register.php", {txtuser:user, txtemail:email, txtpass:pass}, function(data){
                        if(data==0){
                            $("#msgError").html("Registration failed. Please try again.");
                        }else{
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" novalidate>
                    ...
                    <div class="col-12">
                      <button class="btn btn-primary w-100" type="button" id="btnregister">Register</button>
                    </div>
                    <div class="col-12">
